...
<body id="my_chgPw" class="my">
	...
	<section id="main">
		...
		<div class="inner">
			...
			<div class="flex_c">
				...
				<form name="chgPw" action="../my/changePW.do" onsubmit="chk(); return false;" method="post">
					...
					<div id="divBox">
						...
						<div class="div old">
							...
							<input type="password" name="pw"size="25" placeholder="기존 비밀번호를 입력하세요">
						</div>
						
						<div class="div new">
							<h5 class="title">신규 비밀번호</h5>
							<p class="desc">영문자, 숫자, 특수문자를 결합하여 8자~20자 사이로 지정해주세요.</p>
							<input type="password" name="pw_new"size="25" placeholder="신규 비밀번호를 입력하세요">
						</div>
						
						<div class="div newCheck">
							<h5 class="title">신규 비밀번호 확인</h5>
							<input type="password" name="pw_newCheck"size="25" placeholder="신규 비밀번호를 확인하세요">
						</div>
					</div>
	...
	<script>
		...
		let pw = document.getElementsByName('pw_new');
		...
		let pc = document.getElementsByName('pw_newCheck');
