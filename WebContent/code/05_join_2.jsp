...
<body id="join_2" class="join" onload="barFill()">
		...
		<div class="inner">
			...
			<form name="join2" action="../join/account.do" onsubmit="chk(); return false;" method="post">
				...
				<div class="input email">
					...
					<input type="text" name="email_v" value="${EMAIL }" size="25" disabled>
				</div>

				<div class="input pw" id="pw">
					<p class="must">비밀번호</p>
					<p class="desc">영문자, 숫자, 특수문자를 결합하여 8자~20자 사이로 지정해주세요.</p>
					<input type="password" name="pw" size="25" placeholder="비밀번호를 입력하세요">
				</div>
				...
				<div class="input name" id="username">
					...
					<input type="text" name="username" size="25" placeholder="이름을 입력하세요">
				</div>
