...
<body id="rcrt_list">
	...
	<section id="main">
		...
		<div class="inner">
			...
			<ol id="list">
				<li class="post"><a href="01_rcrt_post.jsp">홍대 합주 모집합니다</a></li>
				<li class="post"><a href="01_rcrt_post.jsp">같이 연주하실 분</a></li>
				<li class="post"><a href="01_rcrt_post.jsp">Basket Case 합주</a></li>
				<li class="post"><a href="01_rcrt_post.jsp">재밌게 연주해요~</a></li>
				<li class="post"><a href="01_rcrt_post.jsp">밴드 멤버 모집</a></li>
				<li class="post"><a href="01_rcrt_post.jsp">단기합주 같이해요</a></li>
				<li class="post"><a href="01_rcrt_post.jsp">기타랑 합주하실분</a></li>
				<li class="post"><a href="01_rcrt_post.jsp">홍대 합주 모집합니다</a></li>
				<li class="post"><a href="01_rcrt_post.jsp">같이 연주하실 분</a></li>
				<li class="post"><a href="01_rcrt_post.jsp">Basket Case 합주</a></li>
				<li class="post"><a href="01_rcrt_post.jsp">재밌게 연주해요~</a></li>
